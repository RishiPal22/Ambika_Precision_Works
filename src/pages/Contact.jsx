...
//     )
//     .then((result) => {
//       console.log("Lets us see if this enters here")
//       console.log('EmailJS success:', result.text);
//       setStatus({ ok: true, msg: 'Message sent — check your inbox!' });
//       form.current.reset();
//     })
//     .catch((error) => {
//       console.error('EmailJS error:', error);
//       setStatus({ ok: false, msg: 'Failed to send. See console for details.' });
//     })
...
//           <input name="reply_to" type="email" required className="w-full border rounded p-2" />
//         </div>
...
//         {/* Optional small attachment (free plan limits apply). Name it `my_file` if you add attachments in the template */}
//         {/* <div>
//           <label className="block text-sm">Attachment (optional)</label>
//           <input name="my_file" type="file" />
//           <small className="text-xs text-gray-500">Very small files only on free plan.</small>
//         </div> */}
...
//       {status && (
//         <div
//           className={`mt-4 p-3 rounded ${status.ok ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
//         >
//           {status.msg}
//         </div>
//       )}
...
//     emailjs
//       .sendForm('service_duuh1fr', 'template_p3fxlmd', form.current, {
//         publicKey: '8camyyLwv9hs5-Hj4',
//       })
//       .then(
//         () => {
//           console.log('SUCCESS!');
