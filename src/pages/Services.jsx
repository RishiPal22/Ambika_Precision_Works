  ...
  const services = [
    {
      icon: Settings,
      title: "CNC Turning",
      description: "High-precision turning operations for cylindrical components up to 650mm diameter with exceptional surface finish and dimensional accuracy.",
      features: [
    ...
    },
    {
      icon: Cog,
      title: "VMC Machining",
      description: "Advanced Vertical Machining Center operations for complex geometries, multi-axis machining, and high-precision manufacturing.",
      features: [
    ...
    },
    {
      ...
      description: "High-volume production runs with consistent quality, optimized for efficiency while maintaining precision standards.",
      features: [
    ...
    },
    {
      ...
      description: "Manufacturing of critical precision components for demanding applications requiring exceptional accuracy and reliability.",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive quality control using advanced metrology equipment and ISO 9001:2015 certified processes.",
      features: [
    ...
    },
    {
      ...
      description: "Fast-track prototyping services to accelerate product development cycles with quick turnaround times.",
      features: [
  ...
  const industries = [
    {
      icon: Factory,
      name: "Oil & Gas",
      description: "Critical components for drilling, extraction, and refining operations requiring exceptional durability and precision.",
      applications: ["Valve components", "Pump parts", "Drilling equipment", "Pipeline fittings"]
    },
    {
      icon: Shield,
      name: "Defence",
      description: "High-precision manufacturing for defense applications with stringent quality and security requirements.",
      applications: ["Weapon systems", "Vehicle components", "Communication equipment", "Precision instruments"]
    },
    {
      icon: Target,
      name: "Aerospace",
      description: "Ultra-precision components for aerospace applications meeting the highest industry standards and certifications.",
      applications: ["Engine components", "Landing gear parts", "Structural elements", "Avionics housings"]
    },
    {
      icon: Wrench,
      name: "Mining",
      description: "Robust components designed to withstand harsh mining environments while maintaining operational reliability.",
      applications: ["Excavator parts", "Crusher components", "Conveyor systems", "Heavy machinery"]
    },
    {
      icon: Cog,
      name: "General Engineering",
      description: "Versatile manufacturing solutions for diverse engineering applications across multiple sectors.",
      applications: ["Custom components", "Prototype development", "Production parts", "Specialized tooling"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed text-slate-200">
              Comprehensive precision machining services for Oil & Gas, Defence, Aerospace, Mining, 
              and General Engineering industries with ISO 9001:2015 certified quality assurance.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {capabilities.map((capability, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="text-sm text-slate-500">{capability.description}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Our Manufacturing Services</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive CNC and VMC machining solutions delivering precision, quality, and reliability 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 group border border-slate-100">
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              Specialized manufacturing solutions tailored to meet the unique requirements and 
              stringent standards of diverse industrial sectors.
            </p>
          </div>
              ...
              return (
                <div key={index} className="group">
                  <div className="bg-slate-50 rounded-2xl p-8 h-full hover:bg-white hover:shadow-lg transition-all duration-300 border border-slate-100">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-slate-900">{industry.name}</h3>
                    <p className="text-slate-600 mb-6 leading-relaxed">{industry.description}</p>
                    
                    <div className="space-y-2">
                      <div className="text-sm font-semibold text-slate-700 mb-3">Key Applications:</div>
      ...
      <section className="py-24 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Our Manufacturing Process</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              A systematic approach to precision manufacturing ensuring consistent quality and optimal results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900">Design Analysis</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Comprehensive review of specifications, material requirements, and manufacturing feasibility.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900">CNC Programming</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Advanced CAD/CAM programming optimized for efficiency, precision, and surface finish quality.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900">Precision Machining</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                State-of-the-art CNC and VMC operations with continuous monitoring and quality control.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900">Quality Verification</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                100% inspection protocol with advanced measuring equipment and complete documentation.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-slate-200 leading-relaxed">
                Partner with Ambika Precision Works for your critical manufacturing needs. Our expert team 
                is ready to deliver exceptional quality and precision for your most demanding applications.
              </p>
